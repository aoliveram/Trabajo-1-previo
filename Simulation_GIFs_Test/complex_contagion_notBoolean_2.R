...
get_complex_plot <- function(seed1, seed2, N, g, gmat, thresholds1, thresholds2, num_seeds_to_add1, num_seeds_to_add2, plot_dir) {
  ...
  while (spread) {
    ...
    t1_1 <- which(influence_activated_1)
    ...
    t2_1 <- which(influence_activated_2)
  ...
  return(list(seed1 = seed1, num_adopters_1 = num_adopters_1, seed2 = seed2, num_adopters_2 = num_adopters_2, num_steps = step - 1))
}
...
# Run the model
results <- get_complex_plot(seed1, seed2, N, graph, gmat, thresholds1, thresholds2, num_seeds_to_add1, num_seeds_to_add2, plot_dir)
...
image_write(animation, "complex_notBoolean_04.gif")
